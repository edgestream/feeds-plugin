---
name: read-bluesky
description: Use this plugin when asked to read, show, summarize, or explain a https://bsky.app URL.
---

Use `get_feed` from the plugin that provides this skill before generic web retrieval.
...
The plugin validates URLs; source query strings and fragments do not set tool options.
